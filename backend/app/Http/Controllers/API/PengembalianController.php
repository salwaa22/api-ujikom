...
class PengembalianController extends Controller { 
        ...
        try { 
            $pengembalian = DB::transaction(function () use ($request) { 
                ...
                foreach ($peminjaman->detailPinjam as $detail) { 
                    ...
                    // increment() otomatis menambah nilai pada field yangditentukan 
    ...
    { 
        try { 
            ...
            return response()->json([
                'message' => 'Data pengembalian berhasil dihapus. Stok danstatus peminjaman telah dikembalikan ke kondisi semula.' 
            ]); 
